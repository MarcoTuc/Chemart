...
| `torus` | `bool` | `False` | spatial | grid and hexagon only: close the window into a torus (the GBF with equations rows north = 0, columns east = 0) instead of a bounded window of the infinite GBF |
