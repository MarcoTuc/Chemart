<!-- Generated by tools/gen_catalog_pages.py from catalog/chemistries/energy-gated-collision.yaml and catalog/explainers/energy-gated-collision.md. Edit those, not this file. -->
...
closed vessel, as in the chapter-2 algorithm: 2-in/2-out collisions keep the population constant. One collision is one step; M collisions are one generation (sec. 2.6.1)
...
Banzhaf, W. & Yamamoto, L. (2015). *Artificial Chemistries*. MIT Press. Section 18.3.3; algorithm from 2.3.3, energetics from 2.2.6 (eqs. 2.28-2.33); the book's bibliography entries [42], [757], [780], [870].
...
*Specification: `catalog/chemistries/energy-gated-collision.yaml` · explainer: `catalog/explainers/energy-gated-collision.md` · generator: `chemart/chemistries/energy_gated_collision.py` · tests: `tests/chemistries/test_energy_gated_collision.py`*
