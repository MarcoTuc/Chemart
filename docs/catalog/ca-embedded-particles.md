...
*Specification: `catalog/chemistries/ca-embedded-particles.yaml` · generator: `chemart/chemistries/ca_embedded_particles.py` · tests: `tests/chemistries/test_ca_embedded_particles.py`*
