<!-- Generated by tools/gen_catalog_pages.py from catalog/chemistries/repressilator.yaml and catalog/explainers/repressilator.md. Edit those, not this file. -->
...
*Specification: `catalog/chemistries/repressilator.yaml` · explainer: `catalog/explainers/repressilator.md` · generator: `chemart/chemistries/repressilator.py` · tests: `tests/chemistries/test_w1_dynamics.py`, `tests/chemistries/test_w1_structure.py`*
